...
!function ($) {
    ...
    Datetimepicker.prototype = {
        ...
        update: function () {
            var date, fromArgs, fallback = false;
            if (arguments && arguments.length && (typeof arguments[0] === 'string' || arguments[0] instanceof Date)) {
                date = arguments[0];
                fromArgs = true;
            } else {
                date = this.element.data('date') || (this.isInput ? this.element.val() : this.element.find('input').val());
        ...
        getValue: function () {
            return this.element.data('date') || (this.isInput ? this.element.val() : this.element.find('input').val()) || this.initialDate;
        },
        ...
        validateOnBlur: function () {
            ...
            if (this.valid(date)) {
                if (date !== this.getFormattedDate()) this.setValue();
        ...
        valid: function (d) {
            ...
            const newDate = DPGlobal.parseDate(d, this.format, this.language, this.formatType);

            if (newDate.getFullYear().toString().length < 4) return false;

            return newDate.getFullYear() !== (new Date(0, 0, 0, 0, 0, 0, 0)).getFullYear();
        },
